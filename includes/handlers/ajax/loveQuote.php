<?php
   ...
   // check if the quote and user id is passed
   if (isset($_POST['quoteId']) && isset($_POST['userId']) && isset($_POST['genre1']) && isset($_POST['genre2']) && isset($_POST['genre3']) && isset($_POST['author'])) {
