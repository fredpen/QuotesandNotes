    ...
    <div class="col-sm-12 topMargin mx-auto">
      ...
      <div class="card card-blog">
         <div id="card-content" class="card-content">
          ...
          <p class="quote-description"><?php echo $editQuote['content']; ?></p>
          ...
          <div class="footer">
             <div class="author">
               <a href="author.php?author=<?php echo $quote->authorId($editQuote['author']);?>">
                  <img src="assets/images/author/<?php echo $editQuote['img'] ?>" alt="<?php echo $editQuote['author'] ?>" class="avatar img-raised">
