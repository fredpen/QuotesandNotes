    ...
    <div class="frow">
        ...
        <div class="main main-raised topMargin0">
            <div class="contact-content">
                <div class="container">
                    <h1 class="title text-center font30">Quotes and Note Cookie Policy</h1>
                    
                    <div class="frow">
                         <h4 class="title width100">Introduction</h4>
                        <p>At QuoteandNote we may use cookies, web beacons, tracking pixels, and other tracking technologies when you visit our website (quotesandNote.com), including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”) to help customize the Site and improve your experience. </p>
                        ...
                        <h4 class="title width100">Use of Cookies</h4>
                        ...
                        <h4 class="title width100">Types of Cookies</h4>
                        <p> The following cookies may be use on our site</p>
                        
                        <ul>
                            <li>
                                <h5 class="title width100">Advertising Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Analytics Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Our Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Personalization Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Security Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Site Management Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">Third-Party Cookies</h5>
                            ...
                            <li>
                                <h5 class="title width100">OTHER TRACKING TECHNOLOGIES</h5>
                        ...
                        <h4 class="title width100">PRIVACY POLICY</h4>
                        <p>For more information about how we use information collected by cookies and other tracking technologies, please refer to our <a href="privacy_policy.php">Privacy Policy</a> posted on the Site. This Cookie Policy is part of and is incorporated into our Privacy Policy. By using the Site, you agree to be bound by this Cookie Policy and our Privacy Policy.</p>
