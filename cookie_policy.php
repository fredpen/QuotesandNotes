    ...
    <div class="frow">
        ...
        <div class="main-container">
            <div class="topMargin65">
                <h4 class="title">Quotes and Note Privacy and cookie Policy</h4>
                ...
                <h4 class="title">use of cookies</h4>
                ...
                <h4 class="title">TYPES OF COOKIES</h4>
                <p>The following types of cookies may be used when you visit the Site:</p>
                <h5 class="title">Advertising Cookies</h5>
                ...
                <h5 class="title">Analytics Cookies</h5>
                ...
                <h5 class="title">Personalization Cookies</h5>
                ...
                <h5 class="title">Security Cookies</h5>
                ...
                <h5 class="title">Site Management Cookies</h5>
                ...
                <h5 class="title">Third-Party Cookies</h5>
                ...
                <h5 class="title">OTHER TRACKING TECHNOLOGIES</h5>
                ...
                <p>If you have questions or comments about this Cookie Policy, please contact us at: contactus@quotesandnote.com</p>
